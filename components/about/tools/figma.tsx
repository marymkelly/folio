...
export default function FigmaIcon<T extends { className: string}>(props: T): JSX.Element {
	return (
		<svg className={props.className} id='Layer_1' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 200 300' width='1667' height='2500'>
