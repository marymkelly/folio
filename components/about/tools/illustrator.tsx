...
export default function IllustratorIcon<T extends { className: string }>(props: T): JSX.Element {
	return (
		<svg className={props.className} xmlns='http://www.w3.org/2000/svg' viewBox='0 0 240 234'>
			<path
				fill='#300'
