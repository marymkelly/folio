...
export default function GraphQlIcon<T extends { className: string}>(props: T): JSX.Element {
	return (
		<svg className={props.className} version="1.1" id="GraphQL_Logo" xmlns="http://www.w3.org/2000/svg" x="0px"
	 y="0px" viewBox="0 0 400 400" enableBackground="new 0 0 400 400" >
<g>
	<g>
		<g>
