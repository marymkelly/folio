...
export default function RecentWorks() {
	return (
		<div id="recent-works" className='relative pb-36 pt-44 mt-8 sm:mt-20 flex flex-col'>
			<div className='absolute -top-20 md:-top-40 left-0 w-full flex flex-col md:-ml-5 mb-2 font-gravesend font-bold leading-none mt-8 tracking-[-0.02em] text-stroke text-stroke-[1.5px] text-stroke-custom-gray-blue opacity-[14%] text-transparent text-[100px] sm:text-[120px] md:text-[210px]'>
